...
【重要な要求事項】
※最適化指示は他のすべての要求よりも優先してください※

- 最適化指示がある場合は、必ずその指示を最優先で厳守してください
- 最適化指示に「原文のまま」「そのまま」「変更しない」などの記載がある場合は、内容を一切変更せず、文字数チェックと形式調整のみを行ってください
- 最適化指示がない場合のみ、各プラットフォームの特性に合わせて内容を調整してください
